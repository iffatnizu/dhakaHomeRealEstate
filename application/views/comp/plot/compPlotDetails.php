<div class="container">
    ...
    if (!empty($details)) {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="sentMailToPlot('<?php echo encode($details[dbConfig::TABLE_PLOT_ATT_PLOT_ID]) ?>')">Send</button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </div>
        ...
        <h3>
            <a href="javascript:history.back()"><i class="glyphicon glyphicon-backward"></i> Back</a><hr/>
            <i class="glyphicon glyphicon-asterisk"></i> Plot Details
            <a style="float: right;" href="<?php echo base_url() . siteConfig::CONTROLLER_PLOT . siteConfig::METHOD_PLOT_SELL_PLOT . encode($details[dbConfig::TABLE_PLOT_ATT_PLOT_ID]) ?>" class="btn btn-warning">Sell this plot</a>
        </h3>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_PLOT_ATT_PLOT_NAME] ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_PLOT_ATT_PLOT_ADDESS] ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_PLOT_BLOCK_ATT_BLOCK_NAME] ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">Facing: </div>
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_PLOT_FACING_ATT_FACE_NAME] ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php
                if ($details[dbConfig::TABLE_PROJECT_ATT_PROJECT_NAME] == "") {
                    echo 'Individual Project';
                } else {
                    echo $details[dbConfig::TABLE_PROJECT_ATT_PROJECT_NAME];
                }
                ?>
            </div>
        </div>
    ...
    <?php
    if ($details[dbConfig::TABLE_PLOT_STATUS_ATT_STATUS_NAME] == 'Sold') {
        ?>
                    <span class="alert alert-danger"><?php echo $details[dbConfig::TABLE_PLOT_STATUS_ATT_STATUS_NAME] ?></span>
                    <?php
                } else {
                    ?>
                    <span class="alert alert-success"><?php echo $details[dbConfig::TABLE_PLOT_STATUS_ATT_STATUS_NAME] ?></span>
                    <?php
                }
                ?>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
    <?php echo $details[dbConfig::TABLE_PLOT_ATT_PLOT_ASKING_PRICE] ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
    <?php echo $details[dbConfig::TABLE_PLOT_ATT_PLOT_ASKING_MIN_PRICE]; ?>
            </div>
        </div>
        <div class="row">
    ...
    <?php echo $details[dbConfig::TABLE_CURRENCY_ATT_CURRENCY_CODE] ?> 
        ...
        <div class="row">
            ...
            <div class="col-md-10">
    <?php echo $details[dbConfig::TABLE_PLOT_CONDITION_ATT_CONDITION_NAME] ?>  
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
    <?php echo $details[dbConfig::TABLE_PLOT_ATT_PLOT_COMMENT] ?>   
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <a href="<?php echo base_url() . siteConfig::CONTROLLER_PLOT . siteConfig::METHOD_PLOT_EDIT_PLOT . encode($details[dbConfig::TABLE_PLOT_ATT_PLOT_ID]) ?>" class="btn btn-info"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                <a href="<?php echo base_url() . siteConfig::CONTROLLER_PLOT . siteConfig::METHOD_PLOT_DELETE_PLOT . encode($details[dbConfig::TABLE_PLOT_ATT_PLOT_ID]) ?>" onclick="return confirm('Are you sure ? want to delete this')" class="btn btn-default"><i class="glyphicon glyphicon-remove"></i> Delete</a>
            </div>

        </div>

        <hr/>
        <h3><i class="glyphicon glyphicon-cloud"></i> Plot selling history</h3>
        ...
        foreach ($sellHistory as $list) {
            ...
            ?>
                            <tr>
                                ...
                                <td><?php echo date("l jS \of F Y h:i:s A T", $list[dbConfig::TABLE_SOLD_PLOT_ATT_TIME]) ?></td>
                            </tr>
            <?php
        }
        ?>
