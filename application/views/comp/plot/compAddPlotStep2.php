<div class="container">
    <h3><i class="glyphicon glyphicon-adjust"></i> Add Plot :: Step 2 <small>(Add Project)</small> </h3>
    <hr/>
                ...
                else
                {
                    ...
                    $.ajax({
                        ...
                        success: function(res)
                        {
                            if (res == '1')
                            {
                                location.href = base_url + "plot/addPlot/step3/"
                            }
                        }
                    })
                }
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <select name="project-type" class="form-control">
                            <option value="">-Please Select-</option>
                            <option value="2" selected="selected">Plot</option>
                        </select>
