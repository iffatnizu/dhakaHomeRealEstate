<div class="container">
    ...
    if (!empty($details)) {
        ...
        <div class="row">
            <div class="col-xs-1">Plot Name: </div>
            <div class="col-xs-2">
        ...
        <div class="row">
            ...
            <div class="col-xs-2">
                <?php echo $details[dbConfig::TABLE_PLOT_STATUS_ATT_STATUS_NAME] ?>
            </div>
        ...
        if ($this->session->userdata('_success')) {
            ?>
            <div class="alert alert-success"><i class="glyphicon glyphicon-ok-sign"></i> Plot Successfully Sold</div>
            <?php
        }
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            <td>Company </td>
                            <td>
                                <select name="company" class="form-control" onchange="getClientAndProjectByCompany(this.value, '<?php echo $details[dbConfig::TABLE_PLOT_ATT_PLOT_PROJECT_ID] ?>')">
                                    <option value="">-Please select-</option>
                                    <?php
                                    foreach ($company as $name) {
                                        if ($name[dbConfig::TABLE_COMPANY_ATT_ID] != $details[dbConfig::TABLE_PLOT_ATT_PLOT_SELLER_ID]) {
                                            ?>
