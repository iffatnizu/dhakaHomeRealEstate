<div class="container">
    ...
    if ($this->session->userdata('_delete')) {
        ?>
        <div class="alert alert-success"><i class="glyphicon glyphicon-ok-sign"></i> Company Successfully Deleted</div>
        <?php
    } elseif ($this->session->userdata('_notdelete')) {
        ?>
        <div class="alert alert-warning"><i class="glyphicon glyphicon-warning-sign"></i> Company could not be Deleted.there was some project related to this company </div>
        <?php
    }
...
// jQuery expression for case-insensitive filter
    ...
    <h3><i class="glyphicon glyphicon-list"></i> Company List</h3>

    <div id="dynamic">
        <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped tablesorter" id="myTable">
            <thead>
            ...
            <tbody>
                ...
                foreach ($companyList as $list) {
                    ...
                    ?>
                    <tr class="dlist">
                        <td class="checkArea"><input type="checkbox" name="checkId[]" value="<?php echo $list[dbConfig::TABLE_COMPANY_ATT_ID]; ?>"/></td>
                        ...
                        <td><?php echo $list[dbConfig::TABLE_COMPANY_ATT_EMAIL]; ?></td>
