<div class="container">
    ...
    <style>
        ...
        <h3><i class="glyphicon glyphicon-asterisk"></i> Commercial Details </h3>


        <div class="row">
            <div class="col-xs-1">Commercial Name: </div>
            <div class="col-xs-2">
            ...
            <div class="col-xs-2">
                <?php echo $details[dbConfig::TABLE_COMMERCIAL_SIZE_ATT_VALUE] ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-2">
                <?php echo $details[dbConfig::TABLE_COMMERCIAL_STATUS_ATT_STATUS_NAME] ?>
            </div>
        ...
        if ($this->session->userdata('_success')) {
            ?>
            <div class="alert alert-success"><i class="glyphicon glyphicon-ok-sign"></i> Commercial Successfully Sold</div>
            <?php
        }
                ...
                <table class="table">
                    <tbody>
                        <tr>
                            <td>Company </td>
                            <td>
                                <select name="company" class="form-control" onchange="getClientAndProjectByCompany(this.value, '<?php echo $details[dbConfig::TABLE_COMMERCIAL_ATT_PROJECT_ID] ?>')">
                                    <option value="">-Please select-</option>
                                    <?php
                                    foreach ($company as $name) {
                                        if ($name[dbConfig::TABLE_COMPANY_ATT_ID] != $details[dbConfig::TABLE_COMMERCIAL_ATT_SELLER_ID]) {
                                            ?>
