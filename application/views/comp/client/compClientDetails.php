<div class="container">
    ...
    if (!empty($details)) {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="sentMailToSingleClient('<?php echo $details[dbConfig::TABLE_CLIENT_ATT_EMAIL] ?>')">Send</button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </div>

        <h3><i class="glyphicon glyphicon-asterisk"></i> Client Details</h3>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_CLIENT_ATT_FILE_NUMBER] ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_CLIENT_ATT_FIRST_NAME] ?> <?php echo $details[dbConfig::TABLE_CLIENT_ATT_LAST_NAME] ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">Address: </div>
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_CLIENT_ATT_ADDRESS] ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_CLIENT_ATT_ZIP] ?>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_CLIENT_ATT_CELL_CONTACT_NUMBER] ?> 
            </div>
        </div>
        <div class="row">
            <div class="col-md-2">Home Number: </div>
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_CLIENT_ATT_HOME_CONTACT_NUMBER] ?> 
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_CLIENT_ATT_EMAIL] ?>  
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php echo $details[dbConfig::TABLE_CLIENT_ATT_COMMENT] ?>   
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <a href="<?php echo base_url() . siteConfig::CONTROLLER_CLIENT . siteConfig::METHOD_CLIENT_EDIT . $details[dbConfig::TABLE_CLIENT_ATT_ID] ?>" class="btn btn-info"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                <a href="<?php echo base_url() . siteConfig::CONTROLLER_CLIENT . siteConfig::METHOD_DELETE_CLIENT . $details[dbConfig::TABLE_CLIENT_ATT_ID] ?>" onclick="return confirm('Are you sure ? want to delete this')" class="btn btn-default"><i class="glyphicon glyphicon-remove"></i> Delete</a>
            </div>

        </div>

        <h3><i class="glyphicon glyphicon-cloud"></i> Client Project</h3>
        ...
        if (!empty($projectList)) {
            ...
            echo '<div class="alert alert-warning">No project found for this client</div>';
        }
        ?>
        <?php
    } else {
