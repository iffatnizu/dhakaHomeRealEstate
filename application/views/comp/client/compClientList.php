<div class="container">
    ...
    if ($this->session->userdata('_delete')) {
        ?>
        <div class="alert alert-success"><i class="glyphicon glyphicon-ok-sign"></i> Client Successfully Deleted</div>
        <?php
    }
    elseif ($this->session->userdata('_notdelete')) {
        ?>
        <div class="alert alert-warning"><i class="glyphicon glyphicon-warning-sign"></i> Client could not be Deleted.there was some project related to this client </div>
        <?php
    }
...
// jQuery expression for case-insensitive filter
    ...
    <h3><i class="glyphicon glyphicon-list"></i> Client List</h3>
        ...
        <table class="table table-bordered table-striped tablesorter" id="myTable">
            ...
            <tbody>
                ...
                foreach ($clientList as $list) {
                    ...
                    ?>
                    <tr class="dlist">
                        <td class="checkArea"><input type="checkbox" name="checkId[]" value="<?php echo $list[dbConfig::TABLE_CLIENT_ATT_ID]; ?>"/></td>
                        ...
                        <td><?php echo $list[dbConfig::TABLE_CLIENT_ATT_EMAIL] ?></td>                        
