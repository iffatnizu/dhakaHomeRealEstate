<div class="container">
    ...
    if (!empty($details)) {
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" onclick="sentMailToApartment('<?php echo encode($details[dbConfig::TABLE_APARTMENT_ATT_APARTMENT_ID]) ?>')">Send</button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </div>
        ...
        <h3>
            ...
            <a style="float: right;" href="<?php echo base_url() . siteConfig::CONTROLLER_APARTMENT . siteConfig::METHOD_APARTMENT_SELL_APARTMENT . encode($details[dbConfig::TABLE_APARTMENT_ATT_APARTMENT_ID]) ?>" class="btn btn-warning">Sell this apartment</a>
        </h3>


        <div class="row">
            <div class="col-md-2">Apartment Project: </div>
            <div class="col-md-10">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <?php
                if ($details[dbConfig::TABLE_APARTMENT_STATUS_ATT_STATUS_NAME] == 'Sold') {
                    ?>
                    <span class="alert alert-danger"><?php echo $details[dbConfig::TABLE_APARTMENT_STATUS_ATT_STATUS_NAME] ?></span>
                    <?php
                } else {
                    ?>
                    <span class="alert alert-success"><?php echo $details[dbConfig::TABLE_APARTMENT_STATUS_ATT_STATUS_NAME] ?></span>
                    <?php
                }
                ?>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <a href="<?php echo base_url() . siteConfig::CONTROLLER_APARTMENT . siteConfig::METHOD_APARTMENT_EDIT_APARTMENT . encode($details[dbConfig::TABLE_APARTMENT_ATT_APARTMENT_ID]) ?>" class="btn btn-info"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                <a href="<?php echo base_url() . siteConfig::CONTROLLER_APARTMENT . siteConfig::METHOD_APARTMENT_DELETE_APARTMENT . encode($details[dbConfig::TABLE_APARTMENT_ATT_APARTMENT_ID]) ?>" onclick="return confirm('Are you sure ? want to delete this')" class="btn btn-default"><i class="glyphicon glyphicon-remove"></i> Delete</a>
            </div>

        </div>

        <hr/>
        <h3><i class="glyphicon glyphicon-cloud"></i> Apartment selling history</h3>
...
//                                    debugPrint($sellHistory);
                        ...
                        foreach ($sellHistory as $list) {
                            ...
                            <tr>
                                ...
                                <td><?php echo date("l jS \of F Y h:i:s A T", $list[dbConfig::TABLE_SOLD_APARTMENT_ATT_TIME]) ?></td>
                            </tr>
                            <?php
                        }
                        ?>
