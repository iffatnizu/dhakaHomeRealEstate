<div class="container">
    <h3><i class="glyphicon glyphicon-adjust"></i> Add Apartment :: Step 3 <small>(Add Client)</small> </h3>
    <hr/>
    <?php
    $d = array();
    foreach ($client as $c) {
        ...
        function checkAddClient()
        {
            ...
            if ($.trim(typename) != "") {
                ...
                else
                {
                    ...
                    $.ajax({
                        type: "POST",
                        url: base_url + "apartment/setClient",
                        data: {
                            "typename": typename,
                            "submit": "1"
                        },
                        success: function(res)
                        {
                            if (res == '1')
                            {
                                location.href = base_url + "apartment/addApartment/step4/"
                            }
                        }
                    })
                }
