<div class="container">
    ...
    if ($this->session->userdata('_success')) {
        ?>
        <div class="alert alert-success"><i class="glyphicon glyphicon-ok-sign"></i> Apartment Successfully Added</div>
        <?php
    }
    $session['_success'] = FALSE;
    $this->session->unset_userdata($session);
    ?>
    <h3><i class="glyphicon glyphicon-adjust"></i> Add Apartment :: Step 1<small>(Add Company)</small> </h3>
    <hr/>
                ...
                else
                {
                    ...
                    $.ajax({
                        ...
                        success: function(res)
                        {
                            if (res == '1')
                            {
                                location.href = base_url + "apartment/addApartment/step2/"
                            }
                        }
                    })
                }
